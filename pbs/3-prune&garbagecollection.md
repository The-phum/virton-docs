...
## 3. 프룬 & 가비지 컬렉션 (Prune & Garbage Collection)
...
## 3.2 가비지 컬렉션(Garbage Collection) 및 수동 실행 기능
...
## 3.3 가비지 컬렉션 상태 및 저장된 작업 정리 정책 목록
...
### 3.3.2 저장된 정책 목록 (Saved Prune Policy List)
