...
## 4.2.5.4.2 백업 정책 설정 (Configuration)
...
## 4.2.5.4.6 문제 해결 (Troubleshooting)
...
## 4.2.5.5 관리자 IP 접근 제어 (IP Access Control)
...
### 4.2.5.5.3 긴급 조치 가이드 (Lockout 상황)
...
## 4.2.6.3 전역 메일 발송 서버 (SMTP) 설정 (관리자 전용)
