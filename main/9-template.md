# **4.8 템플릿 (Template)/마이그레이션 (Migrate)**
...
### 4.8.1.1 컨테이너 템플릿(LXC)/가상머신 이미지(ISO)
...
## 4.8.4 템플릿으로 변환(Convert to template)
...
### 4.8.5.2 가상머신/컨테이너 마이그레이션 진행 예시
